...
<p><a href="?page=canalplan/admin-pages/cp-admin-general.php"> General Options </a> <br />
This sets up various general options for the Canalplan plugin such as the Canalplan API Key and GoogleMaps API Key</p>
<p><a href="?page=canalplan/admin-pages/cp-admin-home.php"> Home Mooring </a><br />
This allows you to set your home mooring location and give it a customised name </p>
<p><a href="?page=canalplan/admin-pages/cp-admin-fav.php"> Favourite Locations </a><br />
This allows you to set up some favourite locations and give them customised names.</p>
<p><a href="?page=canalplan/admin-pages/cp-admin-google.php"> Google Map Options </a><br />
This allows you to set up the various options to do with how Google Maps are displayed.</p>
<p><a href="?page=canalplan/admin-pages/cp-import_route.php"> Import a route from CanalPlan AC </a><br />
...
<p><a href="?page=canalplan/admin-pages/cp-manage_route.php"> Manage Imported Routes </a><br />
Once you've imported a route you might need to make adjustments to the daily totals - this page allows you to do that</p>
<p><a href="?page=canalplan/admin-pages/cp-admin-diagnostics.php"> Diagnostics / Version Information </a><br />
Provides information and diagnostics - You'll need to refer to this page if you've got problems.
</p>
<p><a href="?page=canalplan/admin-pages/cp-admin-update.php"> Bulk Link Notifier </a><br />
